...
const STATS = [
  ...
  { icon: HeartPulse, tint: 'text-[var(--color-primary)] bg-[rgba(8,145,178,0.07)]', label: 'Avg BP', value: '130/85', delta: '↓ improving' },
        ...
        <div style={{ height: 110 }}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={BP} margin={{ top: 5, right: 4, left: 4, bottom: 0 }}>
              ...
              <Tooltip />
              <Area type="monotone" dataKey="v" name="Systolic" stroke="var(--color-primary)" strokeWidth={2.5} fill="url(#bpFill)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
