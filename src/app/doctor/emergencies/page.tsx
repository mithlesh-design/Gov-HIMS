        ...
        <div className="grid sm:grid-cols-2 gap-2.5">
          {admitted.map(b => (
            <div key={b.id} className="flex items-center gap-3 rounded-xl bg-slate-50 p-3">
              <span className={cn("h-10 w-10 rounded-2xl flex items-center justify-center flex-shrink-0", b.ward === 'ICU' ? "bg-red-50 text-red-600" : "bg-[rgba(8,145,178,0.07)] text-[var(--color-primary)]")}><BedDouble className="h-5 w-5" /></span>
              <div className="flex-1 min-w-0">
