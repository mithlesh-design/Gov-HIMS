...
const ARRIVAL_STYLE: Record<Arrival, string> = {
  walk_in: 'bg-[rgba(8,145,178,0.07)] text-[var(--color-primary)]',
  ambulance: 'bg-red-50 text-red-700',
  transfer: 'bg-[rgba(8,145,178,0.07)] text-[var(--color-primary)]',
}
            ...
            <div className="flex items-center justify-between mt-2 flex-wrap gap-2">
              <div className="flex items-center gap-1.5">
                ...
                <button onClick={props.onOrderImaging}
                  className="text-[11px] font-semibold px-2 py-1 rounded-md bg-[rgba(8,145,178,0.07)] text-[var(--color-primary)] hover:bg-[rgba(8,145,178,0.12)] border border-cyan-200 cursor-pointer">
                  Imaging
                </button>
                <button onClick={props.onOrderRx}
                  className="text-[11px] font-semibold px-2 py-1 rounded-md bg-[rgba(8,145,178,0.07)] text-[var(--color-primary)] hover:bg-[rgba(8,145,178,0.14)] border border-[rgba(8,145,178,0.20)] cursor-pointer">
                  ER Rx
                </button>
              </div>
          ...
          {(news || qs || draftSuggestion) && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              ...
              {(draftSuggestion ?? suggestion) && (
                <div className={cn('rounded-lg p-2.5 ring-1', 'ring-blue-200 bg-[rgba(8,145,178,0.07)]')}>
                  <p className="text-[11px] font-bold text-[var(--color-primary)] flex items-center gap-1">AI ESI suggestion</p>
