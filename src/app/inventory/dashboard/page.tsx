    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[
          ...
          { label: 'Maintenance Tasks', value: maintenanceAlerts.length,                         icon: Hammer,        cardBg: 'bg-[rgba(8,145,178,0.07)]/70',   ib: 'text-[var(--color-primary)]',   lb: 'text-[var(--color-primary-dark)]/60' },
