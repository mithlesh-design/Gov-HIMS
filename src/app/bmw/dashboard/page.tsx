...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  Blue:     'bg-[rgba(8,145,178,0.12)]   text-[var(--color-primary-dark)]   border-[rgba(8,145,178,0.20)]',
  Black:    'bg-slate-200  text-slate-800  border-slate-300',
  White:    'bg-slate-50   text-slate-700  border-slate-200',
  Cytotoxic:'bg-[rgba(8,145,178,0.12)] text-[var(--color-primary-dark)] border-[rgba(8,145,178,0.20)]',
}
              ...
              >
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  {log.status === 'collected' && (
                    <button onClick={() => treat(log.id, log.ward + ' ' + log.category)} className="text-[11px] font-semibold px-2 py-1 rounded-md bg-[rgba(8,145,178,0.12)] text-[var(--color-primary)] hover:bg-[rgba(8,145,178,0.20)] cursor-pointer">
